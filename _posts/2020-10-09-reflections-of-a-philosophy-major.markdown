...
The intangible value of the philosophy degree is having a high sensitivity to BS. Refining my BS filter would be on my agenda whether I studied philosophy or not, so I consider my time reading philosophy as providing a head start. There is indisputably greater ROI studying computer science. My only regret is not doing it sooner.
